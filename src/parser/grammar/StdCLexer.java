...
public StdCLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("register", this), new Integer(11));
	literals.put(new ANTLRHashString("sizeof", this), new Integer(79));
	literals.put(new ANTLRHashString("auto", this), new Integer(10));
	...
	literals.put(new ANTLRHashString("signed", this), new Integer(22));
	literals.put(new ANTLRHashString("enum", this), new Integer(29));
	literals.put(new ANTLRHashString("asm", this), new Integer(5));
	literals.put(new ANTLRHashString("static", this), new Integer(13));
	literals.put(new ANTLRHashString("char", this), new Integer(16));
	literals.put(new ANTLRHashString("union", this), new Integer(26));
	literals.put(new ANTLRHashString("while", this), new Integer(37));
	literals.put(new ANTLRHashString("const", this), new Integer(14));
	literals.put(new ANTLRHashString("break", this), new Integer(42));
	literals.put(new ANTLRHashString("extern", this), new Integer(12));
	...
	literals.put(new ANTLRHashString("unsigned", this), new Integer(23));
	literals.put(new ANTLRHashString("struct", this), new Integer(25));
				...
				case '\t':  case '\u000c':  case ' ':
				{
					...
					do {
						if ((LA(1)=='\t'||LA(1)=='\u000c'||LA(1)==' ')) {
							...
							if ( _cnt957>=1 ) { break _loop957; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
	...
	protected final void mLineDirective(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((LA(1)=='\t'||LA(1)=='\u000c'||LA(1)==' ')) {
				...
				if ( _cnt964>=1 ) { break _loop964; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		do {
			if ((LA(1)=='\t'||LA(1)=='\u000c'||LA(1)==' ') && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && (true)) {
				...
				if ( _cnt966>=1 ) { break _loop966; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
		...
		else if ((_tokenSet_8.member(LA(1))) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && (true)) {
			mID(true);
			fi=_returnToken;
			if ( inputState.guessing==0 ) {
			...
			try {
				...
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt1029>=1 ) { break _loop1029; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
		...
		if ( synPredMatched1031 ) {
			...
			if ( synPredMatched1040 ) {
				...
				do {
					...
					default:
					{
						if ( _cnt1054>=1 ) { break _loop1054; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
					}
					_cnt1054++;
				} while (true);
				...
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					do {
						if (((LA(1) >= '0' && LA(1) <= '9'))) {
							...
							if ( _cnt1043>=1 ) { break _loop1043; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
 ...
 */
	public final void mID(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		_loop1058:
		do {
			if ((_tokenSet_8.member(LA(1))) && (true) && (true)) {
				mIDletter(false);
			}
	...
	public final void mCharLiteral(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		match('\'');
		{
		if ((LA(1)=='\\') && (_tokenSet_11.member(LA(2))) && (_tokenSet_12.member(LA(3)))) {
			mEscape(false);
		}
		...
		case 'x':
		{
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9')) && ((LA(2) >= '\u0003' && LA(2) <= '\u00ff')) && (true)) {
					...
					if ( _cnt1004>=1 ) { break _loop1004; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
	...
	protected final void mExponent(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt1013>=1 ) { break _loop1013; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
